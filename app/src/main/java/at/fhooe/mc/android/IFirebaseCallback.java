...
public interface IFirebaseCallback {
    ...
    void setNotificationRepeatData(List <Integer>_task, List<Integer> _r, List<String> _c, List<String> _t, List<Boolean> _norm, List<Boolean> _funny, List<Boolean> _snarky, List<Boolean> _cute, List<Boolean> _brutal ,List<Boolean> _notification, List<String> _des, List<List<String>> _label,  List<String> _ref, List<Integer> _count);
