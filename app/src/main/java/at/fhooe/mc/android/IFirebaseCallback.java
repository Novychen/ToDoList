...
public interface IFirebaseCallback {
    ...
    void setAll(List<String> _repeatT, List<String> _deadT, List<Integer> d, List<Integer> m, List<Integer> y, List<Integer> h ,List<Integer> min, List<Integer> task, List<String> des,List<String> ref,List<List<String>> label,List<String> _desrep,List<String> _desdead,List<String> _refrep,List<String> _refdead);
}